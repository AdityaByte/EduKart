...
export default function FooterSection() {
    return (
        <footer className="p-10 border-t border-dashed bg-background">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Edukart, All rights reserved</span>
            </div>
        </footer>
    )
}
